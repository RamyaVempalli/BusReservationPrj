...
insert into Bus(Bus_Id,Bus_No,Bus_Type,Bus_Name,Departure,Destination,No_of_Seats_Available,Capacity,End_Date,Return_Id,Ticket_Price,Schedule_Id)
values(01,'MH-5040','Sleeper','Vinayaka','Mumbai','Pune',10,37,'2022-03-19','2022-03-20',101,560,50)
 ...
 values(50,1,01,500,'Mumbai','Pune','2022-03-19','22:00:00',5,560,'')
